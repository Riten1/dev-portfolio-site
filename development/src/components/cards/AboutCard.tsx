    ...
    <CardWrapper className="bg-purple-600 w-full md:w-1/2 h-auto md:h-[400px]">
      <div className="p-4 md:p-8 flex flex-col justify-between h-full gap-6">
        ...
        <div className="flex flex-col sm:flex-row w-full gap-2">
          <button className="cursor-pointer w-full sm:w-1/2 px-6 py-2 border border-black bg-transparent text-black dark:border-white relative group transition duration-200">
